...
<template>
  <div class='register'>
    ...
    <div class='container'>
      <h6>Username</h6>
      <b-form-input value name='username' v-model='username' placeholder='กรอกชื่อผู้ใช้..'></b-form-input>
    </div>
    <div class='container'>
      <h6>Password</h6>
      <b-form-input value name='password' v-model='password' placeholder='กรอกรหัสผ่าน..'></b-form-input>
    </div>
    <div class='container'>
          ...
          <form>
            <div class='col-sm-12'>
              <div class='row'>
                ...
                <div class='col-sm-3 form-group'>
                  <label>Photo</label>
                  <input class='form-control' id='formFileLg' type='file' name='resume_photo' />
                ...
                <div class='col-sm-3 form-group'>
                  ...
                  <input class='form-control' id='formFileLg' type='file' name='resume_portfolio' />
